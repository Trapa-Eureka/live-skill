...
| **실 LLM 스모크** | 2026-09-07 배포 후 실행: 3회 실패(L2·L3·L4, DESIGN §4) → 수정 후 `compile samples/manual.pdf`가 **11/12(91.7%) 통과**, 44회 호출. **주의: 0.1.0 tarball은 L2/L3/L4 이전 코드라 실제 컴파일이 outline에서 실패** → 0.1.1 패치 대기(§4) |
