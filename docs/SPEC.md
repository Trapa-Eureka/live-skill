...
- [x] npm 패키지명 가용성 1차 조사 (2026-09-06, T11 착수 전 사전 조사): `live-skill` npm 레지스트리 미등록(사용 가능) 확인. 후보 `live-skills`도 미등록 확인 — SPEC이 요구한 "후보 2개" 중 1개만 확보, 나머지 1개와 **최종 확정은 T11에서 사람이 결정**(WORKFLOW §4). 상세: `docs/PUBLISHING.md` §0.
